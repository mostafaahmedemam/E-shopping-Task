...
namespace E_Shopping_App.Repositories
{
    ...
    public class ProductRepository : IProductRepository
    {
       ...
       public async Task<IEnumerable<Product>> GetProductByName(string name)
        ...
        {
            return await _context.Products.Find(p => p.Type == type).ToListAsync();
        }

       public async Task<IEnumerable<Product>> GetProductBySize(string size)
        {
            return await _context.Products.Find(p => p.Size == size).ToListAsync();
